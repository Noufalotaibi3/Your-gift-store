...
<html lang="en">
  <head>
    <title><?php echo $website; ?> - Contact</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
          	<p class="breadcrumbs mb-0"><span class="mr-2"><a href="home.html">Home <i class="fa fa-chevron-right"></i></a></span> <span>Contact Us <i class="fa fa-chevron-right"></i></span></p>
					...
					<div class="col-md-12">
						<div class="wrapper px-md-4">
							<div class="row mb-5">
				        		...
				        		<div class="text">
					            <p><span>Phone:</span> <a href="tel://1234567920">+966 57 656 5443</a></p>
					          </div>
				          </div>
								</div>
								<div class="col-md-3">
				        		...
				        		<div class="text">
					            <p><span>Email:</span> <a href="mailto:info@yoursite.com">giftstoreo@gmail.com</a></p>
					          </div>
				          </div>
								</div>
								<div class="col-md-3">
