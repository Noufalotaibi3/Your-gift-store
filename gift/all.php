...
<html lang="en">
  <head>
    <title><?php echo $website; ?> - All</title>
    <meta charset="utf-8">
  ...
  <body>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
          	<p class="breadcrumbs mb-0"><span class="mr-2"><a href="index.php">Home <i class="fa fa-chevron-right"></i></a></span> <span><a href="#">Occasions <i class="fa fa-chevron-right"></i></a></span> <span>All <i class="fa fa-chevron-right"></i></span></p>
            <h2 class="mb-0 bread">All</h2>
          </div>
        </div>
      </div>
    </section>
    <!-- Start Item -->
            <?php
                ...
                <form action="all.php?id=<?=$category?>&itemid=<?=$row['id']?>" method="post">
    <div class="container">
        <div class="row">
